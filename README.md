...
| **Game running interface - Map boundary / Collision system** | Lack of obvious pause and restart buttons ingame. Players easily hit walls suddenly due to limited vision, lacking advance warnings. | Error prevention | 2 | 3 | 2 | 2 |
...
| **Difficulty system** | The initial version lacks difficulty options, unable to meet the needs of players of different skill levels. | Flexibility and efficiency of use | 4 | 3 | 3 | 4 |
